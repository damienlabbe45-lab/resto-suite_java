public class Food {
    ...
    public String toString() {
        return name + "   " + String.format("%.2f", price) + " euros \n\n";
    }

    public static String foodString(Food[] foods, String message) {
        int i = 1;
        for (Food food : foods) {
            message = message + i + ": " + food.name + " " + String.format("%.2f", food.price) + " euros \n";
            i++;
        }
        return message;
    }
    ...
    public static Food[][] initialize() {
        return new Food[][] {
            {
                new Food("SALADE SERVIE AVEC DU CHÈVRE", 3.56), 
                ...
                new Food("CAROTTES RÂPÉES", 4.12),
                new Food("6 CORNICHONS", 4.67)
            },
            {
                new Food("POULET RÔTI", 12.67), 
                new Food("BLANQUETTE DE VEAU", 12.98),
                new Food("FAUX FILET DE BOEUF", 34.65), 
                new Food("MOUTON AU MIEL ET AUX ÉPICES", 15.89),
                new Food("MAGRET DE CANARD", 19.56), 
                new Food("CÖTES D'AGNEAU RÔTI", 14.99),
                ...
                new Food("AUCUN", 0.00),
                new Food("4 TRANCHES DE JAMBON", 14.45),
                new Food("ENTRECÔTE DE BOEUF", 30.34),
            ...
            {
                new Food("FRITES", 3.12), 
                new Food("RIZ", 1.34), 
                new Food("PATES", 1.01),
                new Food("CONCOMBRE", 1.89), 
                ...
                new Food("AUCUN", 0.00), 
                new Food("RATATOUILLE", 7.12), 
                new Food("PARMESAN RÂPÉ", 1.89)
            }, 
            {
                ...
                new Food("VERRE DE WHISKY", 30.89),
                new Food("VERRE DE VIN JAUNE", 23.81), 
                new Food("VERRE DE VIN ROUGE", 24.80),
                new Food("VERRE DE VIN BLANC", 24.59), 
                new Food("BOUTEILLE DE FUZE TEA", 6.78),
                new Food("VERRE DE JUS DE RAISIN", 5.90), 
                new Food("SIROP à L'EAU", 3.89),
                new Food("CALVADOS", 27.67), 
                new Food("BOUTEILLE DE COCA COLA", 10.34), 
                new Food("CAFÉ", 1.78), 
                new Food("VERRE DE FUZE TEA", 1.34), 
                new Food("VERRE DE COCA COLA", 2.34)
            },
            {
                ...
                new Food("KOUIGN-AMANN (GÂTEAU COMPLET)", 19.98), 
                new Food("TARTE AU SUCRE (GATEAU COMPLET)", 10.98),
